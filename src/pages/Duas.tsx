    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-4 pt-8">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-light">
          {settings.language === "ar" ? "أدعية وأذكار يومية من السنة النبوية" : "Daily supplications from the Sunnah"}
        </p>
      </div>
            ...
            return (
              <div key={dua.id} className="neomorph rounded-3xl p-6 space-y-4 hover:neomorph-pressed smooth-transition">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-semibold">{settings.language === "ar" ? dua.titleAr : dua.titleEn}</h3>
                </div>
