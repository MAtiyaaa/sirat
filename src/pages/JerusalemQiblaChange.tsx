...
const JerusalemQiblaChange = () => {
  ...
  const blocks = [
    {
      icon: Compass,
      titleAr: "القبلة الأولى",
      titleEn: "The First Qibla",
      descAr:
        "توجّه المسلمون في أوائل العهد المدني إلى بيت المقدس، وبقي ذلك مدة من الزمن.",
      descEn:
        "In early Madinan period, Muslims faced Bayt al-Maqdis in prayer for a period of time.",
      gradient: "from-sky-500/20 via-cyan-400/20 to-blue-500/20",
    },
    {
      icon: MapPin,
      titleAr: "التحويل إلى مكة",
      titleEn: "Change Toward Makkah",
      descAr:
        "نزل الأمر بتحويل القبلة إلى المسجد الحرام، فكان التوجّه الدائم لمكة.",
      descEn:
        "Revelation ordained the Qibla to the Sacred Mosque in Makkah; it has remained so ever since.",
      gradient: "from-emerald-500/20 via-teal-400/20 to-cyan-500/20",
    },
    {
      icon: Clock,
      titleAr: "دلالات التحويل",
      titleEn: "Significance",
      descAr:
        "طاعة الأمر الرباني، ووحدة الاتجاه والقبلة، وربط الأمة بمركز التوحيد.",
      descEn:
        "Obedience to divine command, unity of direction, and deepened bond to the center of tawhid.",
      ...
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        <header className="space-y-2">
          ...
          <p className="text-muted-foreground">
            {ar
              ? "ملخص موجز عن القبلة الأولى ثم التحويل إلى المسجد الحرام ودلالاته."
