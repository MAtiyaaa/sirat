...
const JerusalemIsraMiraj = () => {
  ...
  const steps = [
    { icon: Navigation, titleAr: "الإسراء", titleEn: "Al-Isra'",
      ...
      descEn: "The Prophet traveled by night from the Sacred Mosque to Al-Aqsa by divine miracle." },
    { icon: Stars, titleAr: "المعراج", titleEn: "Al-Mi'raj",
      descAr: "العروج من الأقصى إلى السماوات العلا ولِّقاء الأنبياء وفرض الصلوات.",
    ...
    { icon: ArrowRightLeft, titleAr: "العودة", titleEn: "Return",
      ...
      descEn: "The Prophet returned, bringing assurance and light to the believers." },
  ];
      ...
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        <div className="flex items-center gap-4 mb-2">
          ...
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text text-transparent">
            {ar ? "الإسراء والمعراج" : "Al-Isra' & Al-Mi'raj"}
          </h1>
        </div>
