...
import { Book, Heart, Users, Mountain, Ship, Star, Scroll, CloudRain, Wind, Zap, Flame, Baby, Crown, Fish, TreePine, Sun, Moon, ArrowLeft, Leaf } from 'lucide-react';
...
const ProphetStories = () => {
  ...
  const stories: Story[] = [
    ...
    // 3. Idris (AS)
    {
      ...
      storyAr: 'إدريس عليه السلام من أوائل الأنبياء بعد آدم وشِيث، وصفه الله بأنه صِدِّيق نبي، وأنه رفعه مكاناً عليّاً. اشتهر بالعلم والصبر والعمل الصالح، وبتعليم الناس الصناعة والكتابة والخياطة، وأمرهم بطاعة الله واجتناب المعاصي. قصته في القرآن مجملة، وفي الأخبار أنه دعا قومه إلى عبادة الله وحده والثبات على التقوى.',
    ...
    // 5. Hud (AS)
    {
      ...
      storyAr: 'بُعث هود عليه السلام إلى عاد، قومٍ أشدّاء مغترّين بقوتهم، يدّعون منازل في الجبال ويبنون قصوراً ويتكبرون. دعاهم إلى توحيد الله وترك البغي، فكذبوه. توعّدهم الله، فأرسل عليهم ريحاً صرصراً عاتية سبع ليالٍ وثمانية أيام حسوماً، فقطعت دابرهم ونجّى الله هوداً ومن آمن معه.',
      storyEn: 'Hud (AS) was sent to the people of ‘Ad, a powerful nation arrogant in their might. He called them to tawhid and to abandon transgression, but they denied him. Allah sent upon them a furious, bitter wind for seven nights and eight days, cutting them off entirely, while saving Hud and the believers.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 6. Salih (AS)
    {
      ...
      storyAr: 'أُرسل صالح عليه السلام إلى ثمود الذين نحتوا الجبال بيوتاً، فطلبوا آية، فأخرج الله لهم ناقة من الصخرة آية مبصرة، وأمرهم أن يكون لها شِربٌ معلوم وألا يمسوها بسوء. فعَقَروها بغياً، فأخذتهم الصيحة والرجفة فأصبحوا في ديارهم جاثمين، ونجّى الله صالحاً والذين آمنوا.',
    ...
    // 8. Lut (AS)
    {
      ...
      storyAr: 'أُرسل لوط عليه السلام إلى قومٍ فشا فيهم الفاحشة المنكرة، فدعاهم إلى العفاف وترك الخبائث، فكذبوه وهددوه وتطاولوا على ضيوفه. أتى أمر الله فقُلِبَت ديارهم وجُعل عاليها سافلها وأمطِروا حجارة من سجيل، ونجّى الله لوطاً وبناته إلا امرأته كانت من الغابرين.',
    ...
    // 9. Ismail (AS)
    {
      ...
      storyAr: 'تركه أبوه إبراهيم بأمر الله في وادٍ غير ذي زرع مع أمه هاجر، فانفجر زمزم تحت قدمه رحمة من الله. شبّ على التوحيد والصدق وصبر على البلاء، وشارك أباه في رفع قواعد البيت، وامتثل لأمر الله في قصة الذبح. كان داعيةً في العرب وبِذُرّيته جاء خاتم النبيين محمد صلى الله عليه وسلم.',
    ...
    // 10. Ishaq (AS)
    {
      ...
      storyAr: 'بشّر الله إبراهيم وسارة بإسحاق بعد كِبَر، وجعله نبياً، ومن نسله يعقوب والسبط. دعا إلى عبادة الله، وثبت على ملة أبيه إبراهيم في التوحيد والطهارة. كان من سلالة مباركة امتد منها أنبياء كثيرون.',
      storyEn: 'Allah gave Ibrahim and Sarah glad tidings of Ishaq in their old age and made him a prophet. From his lineage came Yaqub and many of the Children of Israel. He upheld his father’s monotheistic creed and purity, calling to worship of Allah alone.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 11. Yaqub (AS)
    {
      ...
      storyAr: 'يعقوب عليه السلام ابن إسحاق، اصطفاه الله، ورُزق بيوسف وإخوته. ابتُلي بفقد يوسف فصبَر جميلاً وتوجّه إلى الله بالرجاء حتى جمع الله شمله به. أوصى أبناءه قبل موته بالتوحيد والثبات على ملة إبراهيم وإسحاق.',
      storyEn: 'Yaqub (AS), son of Ishaq, was chosen by Allah and blessed with Yusuf and his brothers. He was tested by the loss of Yusuf and responded with beautiful patience, hoping in Allah until they were reunited. Before his death, he counseled his children to remain firm upon the creed of Ibrahim and Ishaq.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 12. Yusuf (AS)
    {
      ...
      storyAr: 'رأى يوسف رؤيا السجود فحسده إخوته فألقوه في الجبّ فالتقطه بعض السيارة وبِيع في مصر. ابتُلِيَ بفتنة النساء فاستعصم وصبر فكان السجن أحبّ إليه مما يدعون. برز في السجن بتعبير الرؤى، ثم خرج وولاّه الملك خزائن الأرض، فجاءه إخوته في المجاعة فعفا وصفح، وجمع الله شمله بأبيه يعقوب وتحققت رؤياه.',
    ...
    // 13. Shu'ayb (AS)
    {
      ...
      storyAr: 'بعث الله شعيباً إلى مدين وأصحاب الأيكة يحذّرهم من بخس الميزان والتلاعب بأموال الناس، ويأمرهم بعبادة الله وحده. كذبوه واستهزؤوا، فأخذتهم الرجفة والصيحة وعذاب يوم الظلة، ونجّى الله شعيباً والذين آمنوا معه.',
      storyEn: 'Allah sent Shu’ayb (AS) to Midian and the People of the Thicket, warning them against fraud and injustice, and calling them to worship Allah alone. They denied and mocked him; then a quake, a cry, and the punishment of the covering cloud seized them, while Allah saved Shu’ayb and the believers.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 14. Ayyub (AS)
    {
      ...
      storyAr: 'كان أيوب عليه السلام ذا مال وولد وصحة، فابتلاه ربه في جسده وماله وأهله سنين طويلة، فلم يجزع ولم يشتكُ إلا إلى الله، بل قال: "أني مسّني الضر وأنت أرحم الراحمين". فأمره الله أن يركض برجله فانفجر ماء فاغتسل وشرب فذهب عنه الضر، ورد الله عليه أهله ومثلهم معهم. فكان نبراساً للصابرين.',
    ...
    // 15. Dhul-Kifl (AS)
    {
      ...
      storyAr: 'ذكره الله مع الصابرين، واختلف هل هو نبي أم عبد صالح، والمشهور عند كثير من أهل العلم أنه نبي. اشتهر بقيامه بالعهود وتحمله للأمانات وصبره على الأذى، فكان مثالاً للثبات على الطاعة.',
      storyEn: 'Mentioned by Allah among the patient; scholars differ whether he was a prophet or a righteous man—many hold he was a prophet. He is known for fulfilling covenants, bearing responsibilities, and enduring with patience—an emblem of steadfast obedience.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 17. Harun (AS)
    {
      ...
      storyAr: 'جعل الله هارون وزيراً لموسى يشدّ عضده، وكان أفصح لساناً. شارك في دعوة فرعون وقومه وصبر مع موسى على أذى بني إسرائيل وفتنة العجل، وكان مثالاً للصدق واللين مع الثبات.',
      storyEn: 'Allah appointed Harun (AS) as a minister to Musa to strengthen him; he was more eloquent in speech. He joined in calling Pharaoh’s people, endured the trials of the calf with Musa, and exemplified truthfulness, gentleness, and firmness.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 18. Dawud (AS)
    {
      ...
      storyAr: 'كان داود راعياً ثم آتاه الله مُلكاً ونبوة بعد أن قتل جالوت بإذن الله. أوتي الزبور وصوتاً يسبّح به الجبال والطير، وألان الله له الحديد فصنع الدروع. ضرب مثلاً في العدل والإنابة وكثرة العبادة.',
      storyEn: 'Dawud (AS) moved from shepherding to kingship and prophethood after slaying Goliath by Allah’s leave. He was given the Psalms and a voice with which mountains and birds glorified Allah, and iron was softened for him to fashion armor. He is a model of justice, repentance, and abundant worship.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 19. Sulaiman (AS)
    {
      ...
      storyAr: 'ورث من أبيه داود النبوة والملك، وشكر نعمة الله وسأله مُلكاً لا ينبغي لأحد من بعده، فاستجاب له ربه. بنى بيت المقدس، وساس ملكه بالعدل والحكمة، وجادله الهدهد في خبر سبأ فدعا ملكتها إلى الإسلام فأسلمت لله رب العالمين.',
      storyEn: 'He inherited prophethood and kingship from his father Dawud, thanked Allah, and asked for a unique dominion—Allah granted it. He built Al-Aqsa, ruled with justice and wisdom, received news from the hoopoe of Sheba, and invited its queen to Islam; she submitted to Allah.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 20. Ilyas (AS)
    {
      ...
      storyAr: 'أرسل إلى قوم يعبدون بعل، فدعاهم إلى عبادة الله وحده وذكّرهم بنعم الله، فكذّبه معظمهم. قصته موجزة في القرآن، والعبرة فيها الثبات على التوحيد وإن قلّ الناصر.',
      storyEn: 'Sent to a people worshipping Baal, he called them to worship Allah alone and reminded them of His favors. The Qur’an narrates his story briefly; its lesson is steadfast monotheism even when supporters are few.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 21. Al-Yasa’ (AS)
    {
      ...
      storyAr: 'ذكره الله في عداد المصطفين الأخيار. تابع مسيرة الدعوة بعد إلياس، وأُوتي من الآيات ما يؤيد به دعوته. قصته موجزة ولكنها شاهدة على استمرار النبوة في بني إسرائيل.',
      storyEn: 'Mentioned by Allah among the elect. He continued the mission after Ilyas and was supported by signs. His concise story attests to the continuity of prophethood among the Children of Israel.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
      deathAr: 'غير معلوم',
      deathEn: 'Unknown',
    ...
    // 22. Yunus (AS)
    {
      ...
      storyAr: 'دعا قومه فلم يؤمنوا، فخرج مغاضباً قبل إذن ربه، فكان من المسبّحين في بطن الحوت وقال: "لا إله إلا أنت سبحانك إني كنت من الظالمين" فنجّاه الله وطرحه بالساحل، ثم عاد إلى قومه فآمنوا فمتعهم الله إلى حين.',
    ...
    // 23. Zakariya (AS)
    {
      ...
      storyAr: 'كان زكريا كبير السن وزوجه عاقراً، فدعا ربّه دعاءً خاشعاً طالباً الذرية الطيبة، فاستجاب الله وبشّره بيحيى، وجعل آيته ألا يكلّم الناس ثلاثة أيام إلا رمزاً. كان قائماً على كفالة مريم ويشهد كراماتها، وثبت على الدعوة والعبادة.',
      storyEn: 'Zakariya (AS), elderly and with a barren wife, supplicated humbly for righteous offspring. Allah answered with glad tidings of Yahya and made his sign that he would not speak to people for three days except by gesture. He cared for Maryam and witnessed her miracles, remaining firm in devotion and calling.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
    ...
    // 24. Yahya (AS)
    {
      ...
      storyAr: 'آتاه الله الحكم صبياً، وكان تقياً زاهداً عفيفاً يأمر بالمعروف وينهى عن المنكر. ابتُلي بالظالمين حتى استُشهد، فكان مثال الطهر والثبات على الحق منذ صغره.',
      storyEn: 'Granted wisdom in youth, Yahya (AS) was devout, chaste, and ascetic, commanding good and forbidding evil. He was tried by tyrants and martyred, remaining pure and steadfast upon truth from a young age.',
      birthAr: 'غير معلوم',
      birthEn: 'Unknown',
    ...
    // 25. Isa (AS)
    {
      ...
      descriptionEn: 'The Messiah, son of Mary; a word from Allah and a spirit from Him; granted miracles',
      storyAr: 'وُلد عيسى من مريم البتول بلا أب آيةً من الله، وتكلم في المهد مدافعاً عن طهارة أمه، وأُوتي من المعجزات إحياء الموتى وشفاء الأكمه والأبرص بإذن الله، وأنزل الله عليه الإنجيل. تآمر الكافرون على قتله، فرفعه الله إليه وطُبِّه لهم الشبه على غيره، وسيعود في آخر الزمان حكماً عدلاً متّبعاً لشريعة محمد صلى الله عليه وسلم.',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="glass-effect rounded-2xl p-4 border border-border/30 backdrop-blur-xl">
            <div className="text-xs uppercase text-muted-foreground">
              {settings.language === 'ar' ? 'الميلاد' : 'Birth'}
            </div>
            <div className="text-sm mt-1">
              {settings.language === 'ar' ? selectedStory.birthAr : selectedStory.birthEn}
            </div>
          </div>
          <div className="glass-effect rounded-2xl p-4 border border-border/30 backdrop-blur-xl">
            <div className="text-xs uppercase text-muted-foreground">
              {settings.language === 'ar' ? 'الوفاة' : 'Death'}
            </div>
            <div className="text-sm mt-1">
              {settings.language === 'ar' ? selectedStory.deathAr : selectedStory.deathEn}
            </div>
          </div>
          <div className="glass-effect rounded-2xl p-4 border border-border/30 backdrop-blur-xl">
            <div className="text-xs uppercase text-muted-foreground">
              {settings.language === 'ar' ? 'العمر عند الوفاة' : 'Age at Death'}
            </div>
            <div className="text-sm mt-1">
              {settings.language === 'ar' ? selectedStory.ageAtDeathAr : selectedStory.ageAtDeathEn}
            </div>
          </div>
        </div>
