  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "islamic-deep": "hsl(var(--islamic-deep))",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.6s cubic-bezier(0.22, 1, 0.36, 1) backwards",
        "fade-in-up": "fade-in-up 0.7s cubic-bezier(0.22, 1, 0.36, 1) backwards",
        "scale-in": "scale-in 0.4s cubic-bezier(0.22, 1, 0.36, 1) backwards",
        "slide-up": "slide-up 0.5s cubic-bezier(0.22, 1, 0.36, 1) backwards",
